...
public class LocaleTest01 {
    public static void main(String[] args) {
        //classe locale foi feita pra tratar com internacionalização
        //ele usa a ISO639 e a ISO3166
        Locale localeItaly = new Locale("it", "IT"); //italiano da italia
        Locale localeCH = new Locale("it", "CH"); //italiano da suiça
